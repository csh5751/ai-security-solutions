...
if(exists)return;
var covered=mv.scores&&mv.rationale&&layers.every(function(l){
return typeof mv.scores[l]==="number"&&mv.rationale[l]&&mv.rationale[l].bullets;
});
if(!covered)return;
...
'<div class="hero">'+
'<div><h1>AI SECURITY <span class="accent">VENDOR MAP</span></h1><p>// AISPM · AIDR · Shadow AI · AI Red Teaming · Ops 기준</p></div>'+
...
var lbl=(typeof layerShort!=="undefined"&&layerShort[l])?layerShort[l]:layerLabels[l].substring(0,4);
bars+='<div class="pattern-bar"><div class="pb-label">'+lbl+'</div><div class="pb-fill"><div class="pb-inner" style="height:'+pct+'%;"></div></div><div class="pb-score">'+s.toFixed(1)+'</div></div>';
});
